...
Namespace UsuariosDataSetTableAdapters
    ...
    Partial Public Class UsuariosTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Usuarios` WHERE ((`Usuario` = ?) AND ((? = 1 AND `Clave` IS NULL) OR"& _ 
                " (`Clave` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Usuarios` (`Usuario`, `Clave`) VALUES (?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Usuarios` SET `Usuario` = ?, `Clave` = ? WHERE ((`Usuario` = ?) AND ((? ="& _ 
                " 1 AND `Clave` IS NULL) OR (`Clave` = ?)))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.AdminUsers.My.MySettings.Default.UsuariosConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT     Usuario, Clave"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         Usuarios"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (Usuario = ?)"
        ...
        Public Overloads Overridable Function FillByUser(ByVal dataTable As UsuariosDataSet.UsuariosDataTable, ByVal Usuario As String) As Integer
        ...
        Public Overloads Overridable Function GetDataByUser(ByVal Usuario As String) As UsuariosDataSet.UsuariosDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (Usuario Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Usuario")
            Else
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Usuario As String, ByVal Original_Clave As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Usuario As String, ByVal Clave As String) As Integer
            If (Usuario Is Nothing) Then
        ...
        Public Overloads Overridable Function Update(ByVal Usuario As String, ByVal Clave As String, ByVal Original_Usuario As String, ByVal Original_Clave As String) As Integer
            If (Usuario Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Clave As String, ByVal Original_Usuario As String, ByVal Original_Clave As String) As Integer
            Return Me.Update(Original_Usuario, Clave, Original_Usuario, Original_Clave)
        End Function
    End Class
